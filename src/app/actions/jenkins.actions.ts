...
export const buildLoadSuccessPre = createAction('[App] Build Loaded Pre', props<{ build: Build }>());
export const buildLoadSuccessPost = createAction('[App] Build Loaded Post', props<{ build: Build }>());
